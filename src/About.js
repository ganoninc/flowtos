...
function About(props) {
  return (
    <div className="about">
      ...
      <p>
        As far as I remember, I've always loved taking photos. I started my
        journey with the camera of my father, an old one with a very limited
        ...
        go beyond the limitations of my smartphone and just 2 minutes after the
